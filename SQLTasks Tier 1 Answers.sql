...
SELECT sub.TCourt, CONCAT( sub.firstN,  ' ', sub.lastN ) AS name
FROM (
	SELECT Facilities.name AS TCourt, Members.firstname AS firstN, Members.surname AS lastN
	FROM Bookings
	INNER JOIN Facilities ON Bookings.facid = Facilities.facid
		AND Facilities.name LIKE  'Tennis Court%'
	INNER JOIN Members ON Bookings.memid = Members.memid
	) sub
GROUP BY sub.TCourt, name
ORDER BY name
